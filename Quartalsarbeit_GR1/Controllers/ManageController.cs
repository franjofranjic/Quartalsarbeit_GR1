    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Email = user.Email,
                TelGeschaeft = user.TelGeschaeft ,
                TelPrivat = user.TelPrivat
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Vorname,Nachname,TelPrivat,TelGeschaeft,Email")] IndexViewModel model)
        {
            if (ModelState.IsValid)
            {
                var userId = User.Identity.GetUserId();
                ...
                user.Vorname = model.Vorname;
                user.Nachname = model.Nachname;
                user.TelPrivat = model.TelPrivat;
                user.TelGeschaeft = model.TelGeschaeft;
